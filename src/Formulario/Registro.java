...
/**
 * @Autor JAVIER ANDRES HERRERA MANJARREZ
 */
import java.awt.*;
                        ...
                        if (camNombre.getText().equals("") || camApellidos.getText().equals("")
                            ...
                            try {
                                ...
                                if (resul != false) {
                                    ...
                                    FileReader lectorAchivo;
                                    BufferedReader almacener;
                                    String comprovacion = "";
                                    try {
                                        lectorAchivo = new FileReader(archivo);
                                        almacener = new BufferedReader(lectorAchivo);
                                        try {
                                            comprovacion = almacener.readLine();
                                    ...
                                    try {
                                        ...
                                        linea.println(nombre + "¡" + apellidos + "¡" + sexo + "¡" + fechana + "¡"
                                                + educacion + "¡" + altura + "¡" + edad + "¡" + suitaMilitar + "¡"
                                                + DNI + "¡" + feCEnso + "¡" + direccion + "¡" + calle);
